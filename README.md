...
- [ ] Explain what a token is used for.
      Ans:A token is used for authentication between aclient andaserver to transmit secureinformation
- [ ] What steps can you take in your web apps to keep your data secure?
      Ans: Restrict access to the data by requiring login password and token verification, as well restricting navigation within routes until user is verrified.
- [ ] Describe how web servers work.
      Ans: Servers are computer programs ordevicesthat provide functionality for other devices, funtionalitiessuch as storing and providing informations to clients on request. information it stores can also include hosting of Applications or or an address.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      Ans: Put and Delete methods.
